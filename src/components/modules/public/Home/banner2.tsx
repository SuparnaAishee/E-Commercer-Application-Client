      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-12">
        ...
        <div className="col-span-2 bg-gray-200 p-4 md:p-8 rounded-lg shadow flex flex-col">
          ...
          <div className="pr-0 md:pr-48 pt-4 md:pt-6">
            ...
            <p className="text-gray-600 mb-3 text-sm w-full md:w-3/4 ml-2 md:ml-8"></p>{" "}
            Stock up on high-quality essentials with ease. From farm-fresh
            produce to pantry staples, we’ve got you covered.
            <p className="text-gray-800 font-semibold text-base ml-2 md:ml-8">
              STARTING AT{" "}
              <span className="text-orange-500 text-lg font-bold">$9.19</span>
            </p>
          ...
          <div className="mt-4 md:mt-6">
            <Image
              src="https://res.cloudinary.com/dwelabpll/image/upload/v1734185068/hand-drawn-supermarket-sale-background_23-2149406388_ryicza.jpg"
              alt="TV Promotion"
              width={700}
              height={200}
