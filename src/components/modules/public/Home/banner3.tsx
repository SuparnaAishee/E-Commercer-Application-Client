        ...
        <div className="col-span-2 bg-gray-200 p-4 md:p-8 rounded-lg shadow flex flex-col">
          ...
          <div className="pr-0 md:pr-48 pt-4 md:pt-6">
            <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-3 ml-2 md:ml-8">
              Glow Naturally with Premium Skincare Essentials
            </h2>
            <p className="text-gray-600 mb-3 text-sm w-full md:w-3/4 ml-2 md:ml-8">
              Nourish and rejuvenate your skin with our handpicked collection of
              beauty and skincare products. Shine inside and out!
            </p>
            <p className="text-gray-800 font-semibold text-base ml-2 md:ml-8">
              STARTING AT{" "}
              <span className="text-orange-500 text-lg font-bold">$15.99</span>
            </p>
          ...
          <div className="mt-4 md:mt-6">
            <Image
              src="https://res.cloudinary.com/dwelabpll/image/upload/v1734176656/best-daily-skin-care-product-promotion-web-banner-template_536881-41_nda7hk.jpg"
              alt="TV Promotion"
              width={700}
              height={200}
