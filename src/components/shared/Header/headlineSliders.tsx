...
import { Phone, Mail, MapPin, Globe, ChevronDown, Clock } from "lucide-react";

const InteractiveThinHeader = () => {
  ...
  return (
    <div className="pl-4 pr-4 bg-gray-100 border-b border-gray-200 py-1.5 text-xs hidden md:block">
...
export default InteractiveThinHeader;
