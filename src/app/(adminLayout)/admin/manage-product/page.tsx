                ...
                <Dropdown>
                  ...
                  <DropdownMenu
                    ...
                    onAction={(key) => {
                      if (key === "low-stock") {
                        refetch({
                          // @ts-expect-error TODO refactor: react-query refetch() does not accept a new queryKey; lift these filter params to component state so the query re-runs naturally
                          queryKey: [
                            { name: "limit", value: limit },
                            { name: "page", value: 1 },
