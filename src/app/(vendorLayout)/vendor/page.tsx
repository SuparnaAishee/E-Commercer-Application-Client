    ...
    >
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">
              {email || "Manage your store and tools."}
            </p>
          </div>
        </div>
      ...
      >
        <header className="mb-6">
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Details linked to your vendor account
          </p>
        </header>

        <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          <Field label="Store name" value={name} />
          <Field
            label="Contact email"
            value={email}
            icon={<Mail size={14} />}
          />
          <Field label="Role" value={role} icon={<Sparkles size={14} />} />
          <Field
            label="Member since"
      ...
      <motion.section variants={itemVariants}>
        <header className="mb-4">
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Jump into your storefront tools
          </p>
        </header>
